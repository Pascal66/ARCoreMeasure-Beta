...
public class ImageView extends SurfaceView implements SurfaceHolder.Callback {
        ...
        if (!holdScalePoint && point[1] != null && x == 0)
            ...
            builder.setPositiveButton("是", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    point = toDispalyPoint(point);
                    float x = ImageView.x,
                            y = (float) distance2 / distance1 * x;

                    String message = "Distance1:" + distance1 + " Pixel\n" +
                            "Distance2:" + distance2 + " Pixel\n\n" +
                            "Distance1 : Distance2 = X : Y\n" +
                            distance1 + ":" + distance2 + " = \n" + x + ":" + y + "\n\n";
    ...
    private void insertX() { // 輸入 x
        ...
        //final int result = intent.getIntExtra("result");
        builder.setView(et);
